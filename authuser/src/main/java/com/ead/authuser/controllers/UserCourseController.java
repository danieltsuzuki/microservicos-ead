...
public class UserCourseController {
    ...
    public ResponseEntity<Page<CourseDto>> getAllCoursesByUsers(@PageableDefault(
    ...
    public ResponseEntity<Object> savaSubscriptionUserInCourse(@PathVariable(value = "userId") UUID userId,
